...
int main()
{
	...
	// load textures
	// -------------
	unsigned int woodTexture = loadTexture("F:/ComputerGraph/16340300_ZhaoJle_hw6_v0/code/OpenGL 1/OpenGL 1/wood.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ImGui::Begin("Shadow", &isOpen, ImGuiWindowFlags_MenuBar);

		ImGui::RadioButton("Ortho", &tag, 0);
		ImGui::RadioButton("Perspective", &tag, 1);

		ImGui::Checkbox("move light", &isDynamicLight);
		ImGui::End();
